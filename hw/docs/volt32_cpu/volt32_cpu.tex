...
\section{Registers, Main Widths, etc.}
	...
	\item DLARs
		...
		\item A DLAR's scalar offset field is 7-bit due to the data field
			being 128 bytes long. For LARs with types other than
			\texttt{u8} and \texttt{s8}, the address of a scalar is
			forcibly aligned to the width of its type when used as source
			operands in instructions that read from the full
			\texttt{address} field of the instruction. For example, the
			\texttt{add.s dA, dB.addr, dC} instruction will rely on
			\texttt{dB}'s type to determine what alignment   
...
\section{Instructions}
	...
	\subsection{Group 1 Instructions}
		\begin{itemize}
		%--------
		\item Encoding: \texttt{0001 aaaa aabb bbbb  cccc cc00 00oo oooo}
			\begin{itemize}
			%--------
			\item \texttt{a}: DLAR a
			\item \texttt{b}: DLAR b
	...
	\subsection{Group 2 Instructions}
		...
		\item For these instructions, the value of
			...
			is used to calculate the address being loaded from.
	...
	\subsection{Group 3 Instructions}
		...
		\item Instruction List:
			...
			\item \texttt{ldu8 dA, dB.addr, simm12}
			\item \texttt{lds8 dA, dB.addr, simm12}
			\item \texttt{ldu16 dA, dB.addr, simm12}
			\item \texttt{lds16 dA, dB.addr, simm12}

			\item \texttt{ldu32 dA, dB.addr, simm12}
			\item \texttt{lds32 dA, dB.addr, simm12}
			\item \texttt{ldu64 dA, dB.addr, simm12}
			\item \texttt{lds64 dA, dB.addr, simm12}
	...
	\subsection{Group 4 Instructions}
		\begin{itemize}
		%--------
		%\item Encoding: \texttt{0100 aaaa aabb bbbb  cccc ccii iiii iooo}
		\item Encoding: \texttt{0100 aaaa aabb bbbb  iiii iiii iiii oooo}
			\begin{itemize}
			%--------
			\item \texttt{a}: DLAR a
			\item \texttt{b}: DLAR b
	...
	\subsection{Group 5 Instructions}
		\begin{itemize}
		%--------
		\item Encoding: \texttt{0101 aaaa aabb bbbb  0000 0000 0000 0ooo}
			\begin{itemize}
			%--------
			\item \texttt{a}: DLAR a
			\item \texttt{b}: DLAR b
	...
	\subsection{Group 6 Instructions}
		\begin{itemize}
		%--------
		\item Encoding 0: \texttt{0110 aaaa aabb bbbb  cccc cc00 000j jjjo}
		\item Encoding 1: \texttt{0110 aaaa aabb bbbb  iiii iiii iiij jjjo}
			\begin{itemize}
			%--------
			\item \texttt{a}: ILAR a
			\item \texttt{b}: ILAR b
	...
	\subsection{Group 7 Instructions}
		\begin{itemize}
		%--------
		%\item Encoding: \texttt{0111 aaaa aabb bbbb  cccc ccdd dddv oooo}
		\item Encoding: \texttt{0111 aaaa aabb bbbb  iiii ijjj jjvo oooo}
			\begin{itemize}
			%--------
			\item \texttt{a}: DLAR a
			\item \texttt{b}: ILAR b
	...
	\subsection{Group 8 Instructions}
		\begin{itemize}
		%--------
		\item Encoding: \texttt{1000 aaaa aabb bbbb  cccc ccii iiii Sooo}
			\begin{itemize}
			%--------
	...
	\subsection{Group 9 Instructions}
		\begin{itemize}
		%--------
		\item Encoding: \texttt{1001 aaaa aabb bbbb  cccc ccdd dddd oooo}
			\begin{itemize}
			%--------
			\item \texttt{a}: DLAR a
			\item \texttt{b}: DLAR b
	...
	\subsection{Group 10 Instructions}
		\begin{itemize}
		%--------
		\item Encoding: \texttt{1010 aaaa aabb bbbb  cccc cc00 00vo oooo}
			\begin{itemize}
			%--------
			\item \texttt{a}: DLAR a
			\item \texttt{b}: DLAR b
	...
	%	\begin{itemize}
	%	%--------
	%	\item Encoding: \texttt{1011 aaaa aa00 0000  0000 0000 iiii iioo}
	%		\begin{itemize}
	%		%--------
	...
	%		\begin{enumerate}
	%		%--------
	%		%\item \texttt{fldu8 dA, dB, simm12}
	%		%\item \texttt{flds8 dA, dB, simm12}
	%		%\item \texttt{fldu16 dA, dB, simm12}
	%		%\item \texttt{flds16 dA, dB, simm12}

	%		%\item \texttt{fldu32 dA, dB, simm12}
	%		%\item \texttt{flds32 dA, dB, simm12}
	%		%\item \texttt{fldu64 dA, dB, simm12}
	%		%\item \texttt{flds64 dA, dB, simm12}
	%		%--------
	%		%\item \texttt{fldf32 dA, dB, simm12}
	%		%\item \texttt{fldf64 dA, dB, simm12}
	%		%\item \textit{Reserved for future expansion.}
	%		%\item \textit{Reserved for future expansion.}
	%		\item \texttt{reload dA, imm6}
	%			\begin{itemize}
