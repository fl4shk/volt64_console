...
\section{Registers, Main Widths, etc.}
	...
	\item ILARs
		...
		for the two operating modes of the processor. The location within
		the \texttt{ipc} ILARs can be computed by taking the low 6 bits (6
		because 128 bytes long ILARs) of their addresses.
		...
		instructions being 32-bit and the data field being 128 bytes long.
...
\section{Instructions}
	\subsection{Group 0 Instructions}
		...
		\item Instruction List:
			...
			\item \texttt{add dA, dB.addr, dC}
				...
				a temporary (64 bytes long) vector of element type
				\texttt{dA.type}.
				%--------
				\end{itemize}
	...
	\subsection{Group 5 Instructions}
		...
		adding these two temporary values to a temporary value equivalent
		to the sign extended value of \texttt{isimm6}.
